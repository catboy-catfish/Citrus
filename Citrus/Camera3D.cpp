...
const XMVECTOR& Camera3D::GetPositionVector() const
{
	return this->posVector;
}

const XMFLOAT3& Camera3D::GetPositionFloat3() const
{
	return this->pos;
}

const XMVECTOR& Camera3D::GetRotationVector() const
{
	return this->rotVector;
}

const XMFLOAT3& Camera3D::GetRotationFloat3() const
{
	return this->rot;
}

void Camera3D::SetPosition(const XMVECTOR& pos)
{
...
void Camera3D::AdjustPosition(const XMVECTOR& pos)
{
	this->posVector += pos;
...
void Camera3D::SetRotation(const XMVECTOR& rot)
{
	this->rotVector = rot;
...
void Camera3D::AdjustRotation(const XMVECTOR& rot)
{
	this->rotVector += rot;
...
void Camera3D::SetLookAtPos(XMFLOAT3 lookAtPos)
{
...
const XMVECTOR& Camera3D::GetForwardVector()
{
	return this->vec_forward;
}

const XMVECTOR& Camera3D::GetRightVector()
{
	return this->vec_right;
}

const XMVECTOR& Camera3D::GetBackwardVector()
{
	return this->vec_backward;
}

const XMVECTOR& Camera3D::GetLeftVector()
{
